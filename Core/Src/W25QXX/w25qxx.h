...
// Flash 地址定義
#define FLASH_STATUS_ADDR     0x000000
#define FLASH_CONFIG_ADDR     0x001000
#define FLASH_SECTOR_SIZE     4096

// 函數聲明
void W25QXX_EraseSector(uint32_t SectorAddr);
void W25QXX_WritePage(uint8_t* pBuffer, uint32_t WriteAddr, uint16_t NumByteToWrite);
void W25QXX_ReadData(uint8_t* pBuffer, uint32_t ReadAddr, uint16_t NumByteToRead);
void SaveDeviceStatus(void);
void LoadDeviceStatus(void);
